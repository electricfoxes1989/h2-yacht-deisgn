            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              >
                <Link
                  ...
                  } ${pathname.startsWith('/projects') ? 'opacity-100' : ''}`}
                >
                  Projects
                  <ChevronDown
              ...
              >
                <Link
                  ...
                  className={`inline-flex items-center gap-1 text-[0.8125rem] font-medium uppercase tracking-[0.1em] transition-all duration-500 hover:opacity-60 ${
                    showDark ? 'text-[var(--h2-dark)]' : 'text-white'
                  } ${pathname.startsWith('/about') || pathname.startsWith('/contact/careers') || pathname.startsWith('/contact/team') || pathname === '/team' ? 'opacity-100' : ''}`}
                >
                  About
                  <ChevronDown
                    className={`h-3.5 w-3.5 transition-transform duration-300 ${
