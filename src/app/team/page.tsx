...
export const metadata: Metadata = {
  title: 'The Team | H2 Yacht Design',
  description:
    'Meet the passionate and dedicated designers behind H2 Yacht Design — over 30 years of expertise pushing creative boundaries in superyacht, private jet, and luxury residence design.',
}
      ...
      <section className="section-dark section-padding">
        <div className="container text-center">
          ...
          <p className="text-lg text-white/70 max-w-xl mx-auto mb-10">
            We&rsquo;re always looking for talented designers and creative thinkers to join our studios
            in London and Nice.
          </p>
