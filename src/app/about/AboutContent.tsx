...
interface AboutContentProps {
  featuredNews?: Array<{ _id: string; title: string; slug: { current: string }; publishedAt: string; mainImageUrl?: string; externalUrl?: string }>
}

export default function About({ featuredNews = [] }: AboutContentProps) {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-h2-light">
        <div className="container">
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[var(--h2-border)]" staggerDelay={0.15}>
            {[
              { value: "30+", label: "Years of Excellence" },
              { value: "200+", label: "Completed Projects" },
              { value: "20+", label: "Multi-Disciplinary Designers" },
            ].map((stat) => (
              <motion.div key={stat.label} variants={staggerItem} className="py-12 md:py-16 text-center">
      ...
      {/* H25 Anniversary feature image */}
      <section className="section-padding bg-h2-cream">
        <div className="container">
          <ScrollReveal>
            <figure className="max-w-5xl mx-auto">
              <div className="img-zoom overflow-hidden rounded-2xl aspect-[16/9] bg-h2-navy">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/images/h2-25-anniversary.jpg"
                  alt="H2 Yacht Design 25th Anniversary celebration — 1994–2019"
              ...
              <figcaption className="mt-4 flex items-center gap-3 text-[0.7rem] uppercase tracking-[0.2em] text-h2-muted">
                ...
                />
                Twenty-five years of design — Monaco, 2019
              </figcaption>
            </figure>
          </ScrollReveal>
        </div>
                ...
                return (
                  <motion.div key={article._id} variants={staggerItem}>
                    ...
                    >
                      ...
                      <p className="text-[0.65rem] uppercase tracking-[0.15em] text-h2-muted mb-2">
                      ...
                      <h3 className="text-base md:text-lg font-medium tracking-[-0.02em] text-h2-navy leading-snug group-hover:text-[var(--h2-cyan)] transition-colors">
                        {article.title}
                      </h3>
                    </Link>
                  </motion.div>
      ...
      <section className="section-padding">
        <div className="container">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24 max-w-4xl mx-auto" staggerDelay={0.2}>
            {/* London */}
